...
import app.habitrac.com.databinding.FragmentInsightsupBinding;
...
public class InsightsFragmentup extends Fragment implements OnChartValueSelectedListener {
    FragmentInsightsupBinding binding;
    int active = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentInsightsupBinding.inflate(getLayoutInflater(), container, false);
...
// Crea un array de colores con un color diferente para cada barra
        int[] colors = {Color.parseColor("#FF5722"), Color.parseColor("#673AB7"), Color.parseColor("#E91E63"), Color.YELLOW, Color.MAGENTA};
