...
public class CuestionsDaily extends AppCompatActivity {
    private int currentQuestion = 1;
    private RadioButton q1b1,q1b2,q1b3,q1b4,q1b5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cuestions_daily);
        ...
        RadioButton otherRadioButtonyes = findViewById(R.id.question3_radio_button1);
        RadioButton otherRadioButtonyesO = findViewById(R.id.question3_radio_button6);
        LinearLayout linearV = findViewById(R.id.yesL);
        EditText otherText1 = findViewById(R.id.question3_other_text);
        EditText otherYes = findViewById(R.id.otherYes);
        ...
        otherRadioButtonyes.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    linearV.setVisibility(View.VISIBLE);
                    linearV.setEnabled(true);
                } else {
                    linearV.setVisibility(View.GONE);
                    linearV.setEnabled(false);
                   // otherText1.setText(""); // Clear the text when unchecked
                }
            }
        });
        otherRadioButtonyesO.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    otherYes.setVisibility(View.VISIBLE);
                    otherYes.setEnabled(true);
                } else {
                    otherYes.setVisibility(View.GONE);
                    otherYes.setEnabled(false);
                    // otherText1.setText(""); // Clear the text when unchecked
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                switch (currentQuestion) {
                    ...
                    case 6:
                        ...
                        startActivity(new Intent(CuestionsDaily.this, MainActivity.class));
